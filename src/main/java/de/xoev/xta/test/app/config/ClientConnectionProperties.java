...
public class ClientConnectionProperties {
    ...
    private String transportBasePort;
    ...
    public ClientConnectionProperties(final ClientConnectionProperties ccp) {
        transportBasePort = ccp.getTransportBasePort();
        senderPort = ccp.getSenderPort();
        recipientPort = ccp.getRecipientPort();
        readerPort = ccp.getReaderPort();
    }
}
